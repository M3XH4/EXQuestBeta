...
public class Global {
    ...
    public static void placeColorLine(String msg) {
        int lineLength = msg.length();
        for (int i = 0; i < lineLength; i++) {
            System.out.print(ColorTextManager.BACKGROUND_BLACK + ColorTextManager.BLUE + "-");
            if (i == (lineLength - 1)) {
                System.out.print(ColorTextManager.RESET + "\n");
            }
        }
    }
